...
<template>
  ...
  <div class="mt-4 grid grid-cols-3 gap-4">
    <div class="bg-white p-4 shadow-md rounded-md">
      ...
      <p class="text-2xl font-bold" :class="calcNormals(temperature, 'temperature')">
        {{ temperature }} &deg;C
      </p>
      <p class="text-gray-500">
        Normaler Bereich: {{ calcNormalRangeText("temperature") }} &deg;C
      </p>
    </div>
    <div class="bg-white p-4 shadow-md rounded-md">
      <h3 class="font-bold text-primary2">Humidity</h3>
      <p class="text-2xl font-bold" :class="calcNormals(humidity, 'humidity')">
        {{ humidity }} %
      </p>
      <p class="text-gray-500">
        Normaler Bereich: {{ calcNormalRangeText("humidity") }} %
      </p>
    </div>
    <div class="bg-white p-4 shadow-md rounded-md">
